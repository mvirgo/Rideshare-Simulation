...
int main()
{
    ...
    int nVehicles = 6;
    createTrafficObjects_Paris(streets, intersections, vehicles, backgroundImg, nVehicles); // paris
    //createTrafficObjects_NYC(streets, intersections, vehicles, backgroundImg, nVehicles); // nyc
